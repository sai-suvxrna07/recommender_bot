...
The purpose of the bot is to allow for users to find any movie recommendations, find trailers, and chat with a Google LLM all from the user-interface of discord. The user will simply have to join the server, to find the benefits of a free chatbot. This means users who are struggling to find new movies to their liking and are not sure if the movie will be up to their standards can use this AI and ML model. 

## Usages
- Personalization
  - User Need: Find new movies based on their tastes, preferences, and mood.
  - Bot Functionality: Use AI to analyze the user's interests (e.g., genres, favorite actors, or directors) and provide personalized movie suggestions.
- Discovering Movies Based on Mood or Theme
  - User Need: Find movies that match a specific mood, such as "feel-good," "thrilling," "romantic," or "thought-provoking."
  - Bot Functionality: Recommend movies based on keywords or specific themes, enhancing the user experience by tailoring suggestions to their current mood.
- Finding Movie Trailers
  - User Need: Quickly locate trailers to decide if a movie is appealing.
  - Bot Functionality: Search and share links to movie trailers on platforms like YouTube, offering users a convenient way to preview movies.
...
- !!trailer
  - This command gets the trailer for a movie by saying the title:
  `!!trailer The Shawshank Redepemtion`

- !!chat
  - By using the Open Gemini API the user can chat beyond the capabilities of the standard bot, talking directly to the Google LLM. The user can ask questions such as: 
  `!!chat Hey can you suggest some of the best ever horror movies along the lines of IT: Chapter 2`
    - Allowing for the user to use natural speech and ask questions beyond the discord bot itself
